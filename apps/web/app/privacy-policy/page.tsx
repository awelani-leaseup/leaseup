export default function PrivacyPolicyPage() {
  return (
    <div className='prose prose-lg mx-auto py-40 sm:py-52'>
      ...
      <p>
        {' '}
        Leasuep (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is
        committed to protecting your privacy. This Privacy Policy explains how
        your personal information is collected, used, and disclosed by Leasuep.
      </p>
      <p>
        This Privacy Policy applies to our website, and its associated
        subdomains (collectively, our &quot;Service&quot;) alongside our
        application, Leasuep. By accessing or using our Service, you signify
        ...
        Privacy Policy and our Terms of Service. This Privacy Policy was created
        with{' '}
      ...
      <ul>
        ...
        <li>
          ...
          &quot;we,&quot; &rdquo;us,&quot; or &quot;our,&quot; it refers to
          Leasuep, that is responsible for your information under this Privacy
          Policy.
        </li>
        <li>
          Country: where Leasuep or the owners/founders of Leasuep are based, in
          this case is South Africa
        </li>
        <li>
          Customer: refers to the company, organization or person that signs up
          to use the Leasuep Service to manage the relationships with your
        ...
        <li>
          Personnel: refers to those individuals who are employed by Leasuep or
      ...
      <h1>When does Leasuep use end user information from third parties?</h1>
      <p>
        Leasuep will collect End User Data necessary to provide the Leasuep
      ...
      <h1>When does Leasuep use customer information from third parties?</h1>
      <p>
        ...
        in becoming a Leasuep customer, we receive information from a third
        party that provides automated fraud detection services to Leasuep. We
      ...
      <p>
        Leasuep will collect personal information that you submit to us. We may
      ...
      <p>
        We keep your information only so long as we need it to provide Leasuep
      ...
      <p>
        ...
        any information you transmit to Leasuep or guarantee that your
      ...
      <p>
        Leasuep is incorporated in South Africa. Information collected via our
      ...
      <h1>Is the information collected through the Leasuep Service secure?</h1>
      <p>
      ...
      <p>
        ...
        Leasuep collects depend on your relationship with Leasuep. Personnel may
      ...
      <p>
        ...
        the assets of Leasuep or any of its Corporate Affiliates (as defined
        herein), or that portion of Leasuep or any of its Corporate Affiliates
      ...
      <p>
        ...
        Leasuep, whether by ownership or otherwise. Any information relating to
      ...
      <h1>Governing Law</h1>
      <p>
        This Privacy Policy is governed by the laws of South Africa without
      ...
      <p>
        By using Leasuep or contacting us directly, you signify your acceptance
      ...
      <p>
        ...
        At Leasuep we strongly believe that your data privacy is very important
      ...
      <p>
        ...
        requirements of GDPR. Leasuep processes or stores all personal data in
