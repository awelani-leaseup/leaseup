  ...
  return (
    <div className='prose prose-lg mx-auto py-40 sm:py-52'>
      ...
      <ul>
        ...
        <li>
          Website: site, which can be accessed via this URL: leaseup.co.za
        </li>
      </ul>

      <h1>Introduction</h1>
      <p>
        This Cookie Policy explains how Leasuep and its affiliates (collectively
        "Leasuep", "we", "us", and "ours"), use cookies and similar technologies
        to recognize you when you visit our website/app, including without
        limitation leaseup.co.za and any related URLs, mobile or localized
      ...
      <h1 className=' text-pretty'>What type of cookies does Leasuep use?</h1>
      <p>
      ...
      <h1 className='text-pretty'>Performance and Functionality Cookies</h1>
      <p>
      ...
      <h1 className='text-pretty'>Analytics and Customization Cookies</h1>
      <p>
      ...
      <p>
        ...
        first party basis by Leasuep. The Websites can be embedded with content
      ...
      <ul>
        <li>
          ...
          <a
            ...
            data-cfemail='1665636666796462567a737765736366387579386c77'
          >
            support@leaseup.co.za
          </a>
        </li>
      </ul>
    </div>
