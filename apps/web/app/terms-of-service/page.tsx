export default function TermsOfServicePage() {
  return (
    <div className='prose prose-lg mx-auto py-40 sm:py-52'>
      <h1>Terms & Conditions</h1>
      <p>Updated at 2025-07-08</p>

      <h1>General Terms</h1>
      <p>
        By accessing and placing an order with Leasuep, you confirm that you are
      ...
      <p>
        Under no circumstances shall Leasuep team be liable for any direct,
        ...
        inability to use, the materials on this site, even if Leasuep team or an
      ...
      <p>
        Leasuep will not be responsible for any outcome that may occur during
      ...
      <h1>License</h1>
      <p>
        Leasuep grants you a revocable, non-exclusive, non-transferable, limited
        license to download, install and use the website/app strictly in
        accordance with the terms of this Agreement.
      </p>
      <p>
        These Terms & Conditions are a contract between you and Leasuep
        (referred to in these Terms & Conditions as "Leasuep&#34;, "us&quot;,
        "we" or "our"), the provider of the Leasuep website and the services
        accessible from the Leasuep website (which are collectively referred to
        in these Terms & Conditions as the "Leasuep Service").
      </p>
      <p>
        You are agreeing to be bound by these Terms & Conditions. If you do not
        agree to these Terms & Conditions, please do not use the Leasuep
      ...
      <ul>
        ...
        <li>
          ...
          refers to Leasuep, that is responsible for your information under this
          Terms & Conditions.
        </li>
        <li>
          Country: where Leasuep or the owners/founders of Leasuep are based, in
          this case is{' '}
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit Leasuep and use
          the services.
        </li>
        <li>
          Service: refers to the service provided by Leasuep as described in the
        ...
        <li>
          Website: Leasuep's site, which can be accessed via this URL:
          leaseup.co.za
        </li>
        <li>
          You: a person or entity that is registered with Leasuep to use the
          Services.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of Leasuep or its affiliates, partners,
          suppliers or the licensors of the website/app.
        </li>
      </ul>
      <h1>Return and Refund Policy</h1>
      <p>
        Thanks for shopping at Leasuep. We appreciate the fact that you like to
      ...
      <p>
        ...
        apply to transactions at Leasuep. We’ll be as brief as our attorneys
        will allow. The main thing to remember is that by placing an order or
        making a purchase at Leasuep, you agree to the terms along with
        Leasuep's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, "Suggestions") provided by you to Leasuep with respect to
        the website/app shall remain the sole and exclusive property of Leasuep.
      </p>
      <p>
        Leasuep shall be free to use, copy, modify, publish, or redistribute the
      ...
      <p>
        ...
        contain links to other websites not operated or controlled by Leasuep.
      ...
      <h1>Cookies</h1>
      <p>
        Leasuep uses "Cookies" to identify the areas of our website that you
      ...
      <p>
        You acknowledge and agree that Leasuep may stop (permanently or
        ...
        specifically inform Leasuep when you stop using the Service. You
        acknowledge and agree that if Leasuep disables access to your account,
      ...
      <p>
        Leasuep reserves the right to modify, suspend or discontinue,
      ...
      <p>
        Leasuep may from time to time provide enhancements or improvements to
      ...
      <p>
        ...
        the website/app. You agree that Leasuep has no obligation to (i) provide
      ...
      <p>
        You acknowledge and agree that Leasuep shall not be responsible for any
        ...
        or any other aspect thereof. Leasuep does not assume and shall not have
      ...
      <p>
        Leasuep may, in its sole discretion, at any time and for any or no
      ...
      <p>
        ...
        Leasuep, in the event that you fail to comply with any provision of this
      ...
      <p>
        Termination of this Agreement will not limit any of Leasuep's rights or
      ...
      <p>
        You agree to indemnify and hold Leasuep and its parents, subsidiaries,
      ...
      <p>
        ...
        extent permitted under applicable law, Leasuep, on its own behalf and on
        ...
        practice. Without limitation to the foregoing, Leasuep provides no
      ...
      <p>
        Without limiting the foregoing, neither Leasuep nor any Leasuep's
        ...
        servers, the content, or e-mails sent from or on behalf of Leasuep are
      ...
      <p>
        ...
        of Leasuep and any of its suppliers under any provision of this
      ...
      <p>
        ...
        Leasuep or its suppliers be liable for any special, incidental,
        ...
        of this Agreement), even if Leasuep or any supplier has been advised of
      ...
      <p>
        ...
        notices published by Leasuep on the Services, shall constitute the
        entire agreement between you and Leasuep concerning the Services. If any
        ...
        term, and Leasuep's failure to assert any right or provision under this
        Agreement shall not constitute a waiver of such right or provision. YOU
        AND Leasuep AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO
      ...
      <p>
        Leasuep reserves the right, at its sole discretion, to modify or replace
      ...
      <p>
        ...
        not agree to the new terms, you are no longer authorized to use Leasuep.
      </p>

      <h1>Entire Agreement</h1>
      <p>
        The Agreement constitutes the entire agreement between you and Leasuep
        regarding your use of the website/app and supersedes all prior and
        contemporaneous written or oral agreements between you and Leasuep.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other Leasuep's services, which Leasuep will provide
      ...
      <p>
        ...
        thereof), are owned by Leasuep, its licensors or other providers of such
        ...
        express prior written permission of Leasuep, unless and except as is
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Leasuep's INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and Leasuep concerning the Services or this
      ...
      <p>
        In the event of a dispute, you or Leasuep must give the other a Notice
        ...
        <a
          ...
          data-cfemail='a9dadcd9d9c6dbdde9c5ccc8daccdcd987cac687d3c8'
        >
          [email&#160;protected]
        </a>
        . Leasuep will send any Notice of Dispute to you by mail to your address
        if we have it, or otherwise to your email address. You and Leasuep will
        ...
        days, you or Leasuep may commence arbitration.
      </p>

      <h1>Binding Arbitration</h1>
      <p>
        If you and Leasuep don’t resolve any dispute by informal negotiation,
      ...
      <p>
        ...
        and will become the sole property of Leasuep without any compensation or
        credit to you whatsoever. Leasuep and its affiliates shall have no
      ...
      <h1>Promotions</h1>
      <p>
        Leasuep may, from time to time, include contests, promotions,
      ...
      <p>
        ...
        of Leasuep. Leasuep will be entitled to injunctive or other equitable
        relief (without the obligations of posting any bond or surety) in the
        event of any breach or anticipatory breach by you. Leasuep operates and
        controls the Leasuep Service from its offices in . The Service is not
        ...
        the Leasuep Service from other locations do so on their own initiative
        ...
        include and incorporate the Leasuep Privacy Policy) contains the entire
        understanding, and supersedes all prior understandings, between you and
        Leasuep concerning its subject matter, and cannot be changed or modified
      ...
      <h1>Disclaimer</h1>
      <p>
        Leasuep is not responsible for any content, code or any other
        imprecision.
      </p>
      <p>Leasuep does not provide warranties or guarantees.</p>
      <p>
        In no event shall Leasuep be liable for any special, direct, indirect,
      ...
      <p>
        The Leasuep Service and its contents are provided "as is" and "as
        available" without any warranty or representations of any kind, whether
        express or implied. Leasuep is a distributor and not a publisher of the
        content supplied by third parties; as such, Leasuep exercises no
        ...
        accessible via the Leasuep Service. Without limiting the foregoing,
        Leasuep specifically disclaims all warranties and representations in any
        content transmitted on or in connection with the Leasuep Service or on
        sites that may appear as links on the Leasuep Service, or in the
        products provided as a part of, or otherwise in connection with, the
        Leasuep Service, including without limitation any warranties of
        merchantability, fitness for a particular purpose or non-infringement of
        third party rights. No oral advice or written information given by
        Leasuep or any of its affiliates, employees, officers, directors,
        ...
        foregoing, Leasuep does not warrant that the Leasuep Service will be
      ...
      <ul>
        <li>
          Via Email:{' '}
          <a href='mailto:support@leaseup.co.za'>support@leaseup.co.za</a>
        </li>
      </ul>
    </div>
  );
