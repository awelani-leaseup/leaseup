    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://leaseup-3g.sentry.io/issues/?project=4510074468302928">Issues Page</a>.
