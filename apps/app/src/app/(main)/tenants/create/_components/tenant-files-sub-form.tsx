...
interface TenantFilesContentProps {
  form: any;
}

const TenantFilesContent = ({ form }: TenantFilesContentProps) => {
...
export const TenantFilesSubForm = withForm({
  ...createTenantFormOptions,
  render: ({ form }) => <TenantFilesContent form={form} />,
});
