...
export function PaymentRequestCreateFromJSONTyped(
  json: any,
  ...
  return {
    ...
    sendNotification: !exists(json, 'send_notification')
      ? undefined
    ...
    invoiceNumber: !exists(json, 'invoice_number')
      ? undefined
      : json['invoice_number'],
...
export function PaymentRequestCreateToJSON(
  value?: PaymentRequestCreate | null
): any {
  if (value === undefined) {
    return undefined;
  }
